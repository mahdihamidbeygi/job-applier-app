...
interface JobSkillsAnalysisProps {
  jobId: string;
  jobTitle: string;
  companyName: string;
}
...
export default function JobSkillsAnalysis({ jobId, jobTitle, companyName }: JobSkillsAnalysisProps) {
