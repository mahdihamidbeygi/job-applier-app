...
export class JobSkillsService {
  ...
  async extractSkills(jobDescription) {
    const messages = [
      new SystemMessage(
  ...
  async matchSkillsWithResume(jobSkills, resumeData) {
    const messages = [
      new SystemMessage(
  ...
  async generateTailoredResume(resumeData, jobSkills, skillMatch) {
    const messages = [
      new SystemMessage(
  ...
  async generateTailoredCoverLetter(resumeData, jobSkills, skillMatch, jobTitle, companyName) {
    const messages = [
      new SystemMessage(
