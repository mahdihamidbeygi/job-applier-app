...
from unittest.mock import MagicMock, Mock, patch  # Import MagicMock for nested attributes
...
class TestCoverLetterComposition(unittest.TestCase):
    ...
    def __init__(self):
        ...
        self.job_listing: JobListing = get_object_or_404(
            JobListing, id=self.job_id, user_id=self.user_id
        )
